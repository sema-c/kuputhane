        ...
        btn.addEventListener('click', function (e) {
            ...
            if (query === "") {
                if (userRole === "USER")
                    ...
                    window.location.href = "search-librarian.html";
            } else {
                if (userRole === "USER")
                    window.location.href = `search-user.html?q=${encodeURIComponent(query)}`;
                else
                    window.location.href = `search-librarian.html?q=${encodeURIComponent(query)}`
            }
        });
    }
});
